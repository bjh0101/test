...
<head>
    ...
    <link href="${pageContext.request.contextPath}/res/plugins/fullPage/jquery.fullPage.css" rel="stylesheet"/>
    ...
    <link href="${pageContext.request.contextPath}/res/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/res/css/admin.css" rel="stylesheet"/>
    <style>
        /** skins **/
        #zheng-upms-server #header {background: #29A176;}
        #zheng-upms-server .content_tab{background: #29A176;}
        #zheng-upms-server .s-profile>a{background: url(${pageContext.request.contextPath}/res/images/zheng-upms.png) left top no-repeat;}

        #zheng-cms-admin #header {background: #455EC5;}
        #zheng-cms-admin .content_tab{background: #455EC5;}
        #zheng-cms-admin .s-profile>a{background: url(${pageContext.request.contextPath}/res/images/zheng-cms.png) left top no-repeat;}

        #zheng-pay-admin #header {background: #F06292;}
        #zheng-pay-admin .content_tab{background: #F06292;}
        #zheng-pay-admin .s-profile>a{background: url(${pageContext.request.contextPath}/res/images/zheng-pay.png) left top no-repeat;}

        #zheng-ucenter-home #header {background: #6539B4;}
        #zheng-ucenter-home .content_tab{background: #6539B4;}
        #zheng-ucenter-home .s-profile>a{background: url(${pageContext.request.contextPath}/res/images/zheng-ucenter.png) left top no-repeat;}

        #zheng-oss-web #header {background: #0B8DE5;}
        #zheng-oss-web .content_tab{background: #0B8DE5;}
        #zheng-oss-web .s-profile>a{background: url(${pageContext.request.contextPath}/res/images/zheng-oss.png) left top no-repeat;}
    ...
    <aside id="sidebar">
        ...
        <div class="s-profile">
            <a class="waves-effect waves-light" href="javascript:;">
                <div class="sp-pic">
                    <img src="${pageContext.request.contextPath}/res/images/avatar.jpg"/>
                </div>
                <div class="sp-info">
                    张恕征，您好！
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu system_menus system_1 0">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('系统管理', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('组织管理', 'userList');">系统管理</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 3">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 角色用户管理</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('角色管理', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('用户管理', 'userList');">系统管理</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 6">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-lock-outline"></i> 权限资源管理</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('权限管理', 'userList');">系统管理</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 7">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-more"></i> 其他数据管理</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('公共码表', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('会话管理', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('日志记录', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('键值设置', 'admin');">错误页面</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_2 12" style="display:none;">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('标签管理', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('类目管理', 'userList');">系统管理</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_2 15" style="display:none;">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('文章管理', 'userList');">系统管理</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('回收管理', 'admin');">系统管理</a></li>
                </ul>
            </li>
            <li>
...
<script src="${pageContext.request.contextPath}/res/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/BootstrapMenu.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/device.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/fullPage/jquery.jdirk.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/jquery.cookie.js"></script>
