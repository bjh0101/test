...
<head>
    ...
    <link href="${pageContext.request.contextPath}/res/plugins/bootstrap-table-1.11.0/bootstrap-table.min.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/res/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/res/plugins/jquery-confirm/jquery-confirm.min.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/res/plugins/select2/css/select2.min.css" rel="stylesheet"/>
...
<script src="${pageContext.request.contextPath}/res/plugins/bootstrap-table-1.11.0/bootstrap-table.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/bootstrap-table-1.11.0/locale/bootstrap-table-zh-CN.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/jquery-confirm/jquery-confirm.min.js"></script>
<script src="${pageContext.request.contextPath}/res/plugins/select2/js/select2.min.js"></script>
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            ...
                            $.get("${pageContext.request.contextPath}/deleteUser?id="+ids,function (data) {
