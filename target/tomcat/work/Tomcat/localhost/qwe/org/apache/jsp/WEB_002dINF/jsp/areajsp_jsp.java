 ...
 * Generated at: 2019-07-11 15:59:56 UTC
...
public final class areajsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("/res/js/jquery-3.3.1.min.js\"></script>\r\n");
      out.write("\r\n");
      out.write("    <script>\r\n");
      out.write("        $(function () {\r\n");
      out.write("\r\n");
      ...
      out.write("            $.get(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/selectProvince\",{},function (data) {\r\n");
      ...
      out.write("                $.get(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/selectCity\",{id:$(this).val()},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("                    var obj = JSON.parse(data);\r\n");
      out.write("\r\n");
      out.write("                    //1.获取select\r\n");
      ...
      out.write("                $.get(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/selectCountry\",{id:$(this).val()},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("                    var obj = JSON.parse(data);\r\n");
      out.write("\r\n");
      out.write("                    //1.获取select\r\n");
      ...
      out.write("                    country.append(\"<option>--请选择区县--</option>\")\r\n");
      out.write("                    //2.遍历json数组\r\n");
      out.write("                    $(obj).each(function () {\r\n");
      out.write("\r\n");
      out.write("                        //3.创建<option>\r\n");
